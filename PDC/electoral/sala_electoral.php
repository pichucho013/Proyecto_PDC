...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <header class="page-head">
      ...
      <section class="section-30 section-md-40 section-lg-66 section-xl-bottom-90 bg-gray-dark page-title-wrap" style="background-image: url(../images/sala_electoral_banner.png);">
        <div class="container">
      ...
      <div id="contenido_tsje" style="text-align: center;">
