              ...
              <div class="col-md-6 text-md-right">
                <div class="group-sm group-middle">
                  ...
                  <ul class="list-inline list-inline-reset">
                    ...
                    <li><a class="novi-icon icon icon-circle icon-bright-gray-filled icon-xxs-smaller fa fa-youtube" href="https://www.youtube.com/channel/UCQlRSiCKtDPjiA39i1bJxlw?view_as=subscriber" target="_blank"></a></li>
                  </ul>
                </div>
              </div>
